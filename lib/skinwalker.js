...
const trace = (message, namespace='anonymous', callback= () => {}) => {

    if (logLevel <= 0){
        
        var msg = '[TRACE]    ' + '[' +namespace + ']    ' + dateFormat(defaultParams.traceMessageFormat, new Date()) + '    ' + message
...
const info = (message, namespace='anonymous', callback= () => {}) => {

    if (logLevel <= 1){
        
        var msg = '[INFO]    ' + '[' +namespace + ']    ' + dateFormat(defaultParams.infoMessageFormat, new Date()) + '    ' + message
...
const warn = (message, namespace='anonymous', callback= () => {}) => {

    if (logLevel <= 2){
        
        var msg = '[WARN]    ' + '[' +namespace + ']    ' + dateFormat(defaultParams.warnMessageFormat, new Date()) + '    ' + message
...
const error = (message, namespace='anonymous', callback= () => {}) => {

    if (logLevel <= 3){
        
        var msg = '[ERROR]    ' + '[' +namespace + ']    ' + dateFormat(defaultParams.errorMessageFormat, new Date()) + '    ' + message
